...
const ContactPage = () => {
    return (<div style={{marginRight: 120}} className="align-content-center">
        ...
        <Row className="g-0 justify-content-center">
            ...
            <Col md={2} style={{marginRight: 120}}><Card style={{width: 350, height: 535}}><Row
            ...
            <Col md={2}><Card style={{width: 350, height: 535}}><Row className="justify-content-center"><img
