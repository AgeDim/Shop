        ...
        <Container className="d-flex justify-content-center align-items-center"
            ...
            <Card style={{width: 600}} className="p-5">
                ...
                <Form className="d-flex flex-column">
                    ...
                    <Form.Control id="log_email" className="mb-4" placeholder="Введите ваш e-mail...." type="email"></Form.Control>
                    <div id="log_err_msg" style={{color: "red"}}></div>
                    <h5 className="mt-4">Пароль</h5>
                    <Form.Control id="log_pass" className="mb-4" placeholder="Введите ваш пароль...." type="password"></Form.Control>
                    <a href="" className="align-self-lg-end" style={{fontSize:13, color: "black", textDecoration:"none"}}>Забыли пароль?</a>
                    <Button className="w-20 align-self-center" variant="secondary" color="gray" onClick={loginUser}>Вход</Button>
