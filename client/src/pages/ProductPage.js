...
const ProductPage = observer(() => {
    ...
    const [prod1, setProd1] = useState({
        id: '', type: '', name: '', price: 0, description: ''
    })
    ...
    const addProductToBasket = () => {
        if (user.isAuth) {
            if (!compare()) {
                basket.addProducts({
                    id: prod1.id, amount: document.getElementById("counterVal").innerText, price: prod1.defaultPrice
                })
    ...
    return (<Card className="align-self-center" style={{height: 590, marginTop: 10, marginRight: 20, marginLeft: 20}}>
        ...
        <Row>
            <Col md={7} className="d-flex justify-content-center"><Image src={`data:image/jpeg;base64,${prod1.img}`}
